...
(function (global) {
  ...
  // The wishlist is stored PER-USER as an array of {id,title,price,image,...}
  // under bd_wishlist::<email> (written by js/wishlist.js via BDWishlist, the
  // SAME store used by wishlist.html / product.html / cart save-for-later).
  // This keeps price-drop detection in sync with the server-synced wishlist.
  function readWishlist() {
    var key = 'bd_wishlist::' + (email() || 'guest');
    try {

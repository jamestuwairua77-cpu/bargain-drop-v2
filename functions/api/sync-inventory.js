...
export async function onRequest(context) {
  ...
  try { const { body } = await shopifyFetch(env, '/products/count.json'); return new Response(JSON.stringify({ success: true, count: body.count }), { headers: { 'Content-Type': 'application/json', ...corsHeaders() } }); }
